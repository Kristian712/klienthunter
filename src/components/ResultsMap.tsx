...
const T = {
  ...
  // Pulz dostávají jen doložená „web nemá" (viz níž). Bez vyhledávače takový verdikt nepadne,
  // takže věta musí říct i to — jinak slibuje pohyb na obrazovce, kde se nic nehýbe.
  legPulse: { cs: 'Pulzují nejlepší firmy s ověřeným „web nemá". Dokud neběží vyhledávač, nepulzuje nic — většina firem je „web neověřen".',
              sk: 'Pulzujú najlepšie firmy s overeným „web nemá". Kým nebeží vyhľadávač, nepulzuje nič — väčšina firiem je „web neoverený".',
              en: 'The pulsing points are the best firms with a verified “no website”. While the search engine is off nothing pulses — most firms are “unverified”.' },
