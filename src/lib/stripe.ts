...
// Zkušební období a pravidlo „jen poprvé" bydlí v `plans.ts`, protože je čte i ceník
// v prohlížeči — a tenhle soubor tahá Stripe SDK, který do klientského bundlu nepatří.
export { TRIAL_DAYS, trialDaysFor } from './plans';
